...
export const achievements = {
    ...
    bronze_team_player: {
        ...
        type: 'breakthrough',
        name: 'Need help',
        text: 'Hire three employees to your team at the same time.',
    ...
    silver_team_player: {
        ...
        type: 'breakthrough',
        name: 'Need help',
        text: 'Hire six employees to your team at the same time.',
    ...
    gold_team_palyer: {
        ...
        type: 'breakthrough',
        name: 'Need help',
        text: 'Hire nine employees to your team at the same time.',

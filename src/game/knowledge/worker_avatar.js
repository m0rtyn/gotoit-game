...
const bodySVG = require.context("../../assets/images/man_asset/00_body/", true, /^\.\/.*\.svg$/);
const eyesSVG = require.context("../../assets/images/man_asset/01_eyes/", true, /^\.\/.*\.svg$/);
const eyebrowsSVG = require.context("../../assets/images/man_asset/02_eyebrows/", true, /^\.\/.*\.svg$/);
const nosesSVG = require.context("../../assets/images/man_asset/03_nose/", true, /^\.\/.*\.svg$/);
const mouthesSVG = require.context("../../assets/images/man_asset/04_mouth/", true, /^\.\/.*\.svg$/);
const beardsSVG = require.context("../../assets/images/man_asset/05_beard/", true, /^\.\/.*\.svg$/);
const accessoriesSVG = require.context("../../assets/images/man_asset/06_accessories/", true, /^\.\/.*\.svg$/);
const clothesSVG = require.context("../../assets/images/man_asset/07_clothes/", true, /^\.\/.*\.svg$/);
const hairSVG = require.context("../../assets/images/man_asset/08_hair/", true, /^\.\/.*\.svg$/);
...
export const generateMaleAvatar = () => {
    ...
    return {
        ...
        eyebrows: eyebrowsSVG(`./${_.sample(male_avatar.eyebrows[hair_color])}.svg`),
        nose: nosesSVG(`./${_.sample(male_avatar.nose)}.svg`),
        mouth: mouthesSVG(`./${_.sample(male_avatar.mouth)}.svg`),
        beard: have_beard ? beardsSVG(`./${_.sample(male_avatar.beard[hair_color])}.svg`) : null,
        accessories: have_accessories ? accessoriesSVG(`./${_.sample(male_avatar.accessories)}.svg`) : null,

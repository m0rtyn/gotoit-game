export const meetings = {
    fire: {
        ...
        deadline: 1,
        max_bonus: 4,
        description: "Urgent overtime for several hours to solve a critical problem."
    },
    status: {
        name: "Status",
        deadline: 1,
    ...
    training: {
        ...
        deadline: 0,
        max_bonus: 0,
        description: "An interesting educational project, tailored specifically for the development of your team's skills."
    },
    planing: {
        name: "Planing",
        deadline: 8,
    ...
    teambuilding2: {
        ...
        deadline: 8,
        max_bonus: 168 * 4,
        description: "Team Building fills with the belief in the common cause and increases the motivation."
    },
    teambuilding: {
        name: "Team Building",
        deadline: 8,

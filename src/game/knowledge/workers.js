...
export const worker_character_types = [
    ...
    {
        name: "Workaholic",
        description: "Spends more time on work, but often requires an increase in earnings"
    },
    {
        name: "Wonk",
        description: "Likes to learn, but often gets distracted by extraneous things"
    },
    {
        name: "Gifted",

...
export const project_kinds = {
    ...
    game: {
        name: "Game",
        description: "For Games, design is important, but do not forget about programming."
    },
    site: {
        name: "Site",
        description: "For Sites, design is important, but do not forget about management."
    },
    editor: {
        name: "Editor",
        description: "For Editors, programming is important, but do not forget about design."
    },
    magazine: {
        name: "Magazine",
        description: "For Magazines, management is important, but do not forget about design."
    },
    service: {
        name: "Service",
        description: "For Services, management is important, but do not forget about programming."
    },
    database: {
        name: "Database",
        description: "For Databases, programming is important, but do not forget about management."
    }
};

        ...
        return (
            <div className="footer">
                <span className="pull-left">
                    <a href="#" onClick={this.props.newGame} title="Hard Reset For Developers">
                        New game
                    </a>
                </span>
                <span className="pull-left achievements-button">
                    <a
                        onClick={() => {
                ...
                <span>
                    <a onClick={() => data.helpers.changeContent("Charts")} href="#" title="Charts bar">
                        Charts
                    </a>
                </span>
                &nbsp;

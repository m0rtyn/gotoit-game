            ...
            {worker.in_vacation || worker.to_vacation ? (
              worker.in_vacation ? (
                ...
                <h4>
                  ...
                  {Math.floor(worker.to_vacation_ticker / 24)} days
                </h4>
              )
            ) : (
              ''
          ...
          <div className="col-6 worker-statistic">
            ...
            <ul className="statistic-list mb-0">
              ...
              <li className="statistic-item">
                ...
                <span>
                  {Math.ceil(
                    (this.props.data.date.tick - worker.facts.tick_hired) / 24
                  )}
                </span>
              </li>
              <li className="statistic-item">
        ...
        <div className="modal-body">
          <ul className="nav nav-tabs nav-tabs-light-mode">
            <li className="nav-item">
              <a
                className={`nav-link ${
                  state.currentTab === 0 ? 'active show' : ''
                }`}
                onClick={() => {
            ...
            <li className="nav-item">
              <a
                className={
                  'nav-link ' + (state.currentTab === 1 ? 'active show' : '')
                }
                onClick={() => {

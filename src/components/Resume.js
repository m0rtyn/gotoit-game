        ...
        return (
            <div className="resume">
                <div className="flexbox">
                    ...
                    <span><button className="btn btn-warning " onClick={() => {
                ...
                <h2>Character:</h2>
                <h3>{worker.character.name}. {worker.character.description}</h3>
                { !worker.hired
                    ? <div>
                        <button className="btn btn-success" id={worker.id} onClick={ (e) => {
                            this.props.data.helpers.hireCandidate(e.target.id, 'resumes');
                            this.props.closePopup();
                        }}>Hire</button>
                        <button className="btn btn-danger" id={worker.id} onClick={(e) => {

...
class Office extends Component {
    render() {
        ...
        const coffeemaker = <div className="card panel-warning">
        ...
        const lunch = <div className="card panel-warning"> After a delicious Lunch for $25, employees will stay at work until night.
        ...
        const gadget = <div className="card panel-warning"> Fancy gadgets gives 1% happiness Boost per gadget. You Own:

...
class Office extends Component {
  render() {
    ...
    const coffeemaker = (
      <div className="card">
        {data.office_things.coffeemaker ? (
          ...
          <div>
            Workers will come to work earlier if there is a Coffeemaker in the
            office.
            <button
              onClick={() => {
              ...
              className={
                data.money >= 5000 ? 'btn btn-info' : 'btn btn-info disabled'
              }
            >
    ...
    const lunch = (
      <div className="card">
        {' '}
        After a delicious Lunch for $25, employees will stay at work until
        night.
    ...
    const gadget = (
      <div className="card">
        ...
        <button
          ...
          className={
            data.money >= data.helpers.getGadgetCost()
              ? 'btn btn-info'

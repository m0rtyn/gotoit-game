...
class Office extends Component {
    render() {
            ...
            <div className="card">
                {data.office_things.coffeemaker 
                    ...
                    : <div>
                        ...
                        <button 
                            onClick={() => {data.helpers.buyCoffeemaker();}} 
                            className={data.money >= 5000 
                                ? "btn btn-info" 
        ...
        const lunch = <div className="card"> After a delicious Lunch for $25, employees will stay at work until night.
        ...
        const gadget = <div className="card"> Fancy gadgets gives 1% happiness Boost per gadget. You Own:

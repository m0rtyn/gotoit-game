            ...
            <div className="row filament">
                ...
                <div className="slim col-md-8">
                    ...
                    <div className="panel panel-success text-center">
                        ...
                        />
                        <p className="filament">{project_kinds[_.keys(project_kinds)[this.state.project_kind]].description}</p>
                    </div>
                </div>
            </div>
            <div className="text-center">
                <button className="big btn-success btn-lg" onClick={() => {
                    this.props.data.helpers.startProject(this.state.project_name, this.state.selected_workers, this.state.project_platform, this.state.project_kind); }

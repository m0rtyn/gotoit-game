  ...
  render() {
    ...
    const start_pause_button = (
      <span>
        {/*{project.stage}*/}
        {project.is_paused ? (
          <button className="btn btn-success" onClick={this.unpause}>
            Start
          </button>
        ) : (
          ''
        ...
        {project.stage === 'open' && !project.is_paused ? (
          <button className="btn btn-warning" onClick={this.pause}>
            Pause
          </button>
        ) : (
          ''
    ...
    return (
      <div className="card fat">
        <div className="">
          ...
          {project.penalty > 0 ? (
            <span className=""> Penalty: {project.penalty}$ </span>
          ) : (
            ' '
          )}
          <div>

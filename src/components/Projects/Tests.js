            ...
            <div key="tests" className="row">
                ...
                <div className="col-10 progress">
                    <div
                        ...
                        role="progressbar"
                        style={{
                            width: 100 - (this.props.tests / this.props.planedTasksQuantity()) * 100 + "%"
                        }}
                    >
                        <span>{this.props.planedTasksQuantity() - this.props.tests} tasks</span>
                    </div>
                    <div
                        className="progress-bar bg-success"
                        role="progressbar"
                        style={{
                            width: (this.props.tests / this.props.planedTasksQuantity()) * 100 + "%"
                        }}
                    >

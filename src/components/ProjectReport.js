    ...
    return (
      <div className="card">
        ...
        <p className="small">
          ...
          {tech.length ? (
            <span className="small"> and tech {tech_label}.</span>
          ) : (
            ' '
          )}
          {project.facts.money_spent
            ? `Spent ${project.facts.money_spent}$ for salary. `
            : ''}
          {project.facts.tasks_done
            ? `Did ${project.facts.tasks_done} tasks. `
            : ''}
          {project.facts.bugs_passed
            ? `Passed ${project.facts.bugs_passed} bugs. `
            : ''}
          {project.facts.refactored
            ? `Did ${project.facts.refactored} refactoring. `
            : ''}
        ...
        <div className="">
          ...
          <div className="">
            {' '}
            Bugs: <span className="text-danger">
